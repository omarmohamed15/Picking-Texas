...
def tester1(input_hdf5=None,
    ...
    np.save('pred_PP_mean_all.npy',pred_PP_mean_all)
    np.save('pred_PP_std_all.npy',pred_PP_std_all)
    np.save('pall.npy',sptall)
...
tester1(input_hdf5= './TXED_0919.h5',
       input_testset='test_EQ.npy',
       input_model='./EQCCT_TF_TEXAS/test_trainer_005.h5',
